...
.endif;
    ...
    //------------------------------------------------------------------------
    //! \fn void core_ClipMul4D4W4_AddVr(nmreg nb1, nmreg sb, nmreg F1CR, nmreg vr, nmreg ar0, nmreg gr0, nmreg ar1, nmreg gr1, nmreg ar2, nmreg gr2, nmreg ar3, nmreg gr3, nmreg ar4, nmreg gr4, nmreg gr5, nmreg ar6, nmreg gr6)
    //!
    //------------------------------------------------------------------------

global core_ClipMul4D4W4_AddVr:label;
      <core_ClipMul4D4W4_AddVr>
.branch;
