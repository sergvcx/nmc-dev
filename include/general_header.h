...
//*****************************************************************************
    ...
    \brief
    	...
    	Функция транспонирует матрицу заданного размера, состоящую из 32-разрядных чисел.
		\~
		\~
    \param FirstMatrix
    ...
    \param SecondMatrix
		...
		\~
	\param Height
        Высота изначальной матрицы в элементах.
		\~
	\param Width
        Ширина изначальной матрицы в элементах.
		\~
    \return \e void
