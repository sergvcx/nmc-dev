...
\renewcommand{\familydefault}{\sfdefault}
  ...
  \fancypagestyle{fancyplain}{
    ...
    \fancyfoot[LO, RE]{\bfseries\scriptsize Документация по ringbuffer. Последние изменения\+: Ср 16 Авг 2023 19\+:12\+:18. Создано системой Doxygen }
  }
...
\begin{document}
  ...
  {\Large ringbuffer}\\
  \vspace*{1cm}
  {\large Документация по ringbuffer. Последние изменения\+: Ср 16 Авг 2023 19\+:12\+:18. Создано системой Doxygen 1.9.7}\\
    \vspace*{0.5cm}
    {\small Ср 16 Авг 2023 19:12:18}
  \end{center}
  \end{titlepage}
